...
DWORD
RvaToOffset(LPVOID fileBase, DWORD rva) {
...
bool EnableStealthMode(HANDLE hThread) {
  ...
  //  WriteProcessMemory(pi.hProcess, (LPVOID)(processHeapAddr + 0x70),
  //  &heapFlags, sizeof(heapFlags), nullptr);

  // HeapForceFlags = ProcessHeap + 0x74
  //  WriteProcessMemory(pi.hProcess, (LPVOID)(processHeapAddr + 0x74),
  //  &heapForceFlags, sizeof(heapForceFlags), nullptr);
